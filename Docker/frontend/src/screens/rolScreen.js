...
const RolesScreen = () => {
  ...
  const renderHeader = () => (
    <View style={styles.tableHeader}>
      ...
      <Text style={[styles.headerText, styles.nameColumn]}>Rol</Text>
      <Text style={[styles.headerText, styles.descColumn]}>Descripción</Text>
  ...
  const renderItem = ({ item }) => (
    <View style={styles.tableRow}>
      ...
      <Text style={[styles.cellText, styles.descColumn]}>
